...
Die Projektdateien für das Kapitel 11 vom Buch **Zend Framework 2 - Von den 
...
* Sie können die Projektdateien als ZIP von der Website http://www.awl.de/2994 
  unter Downloads oder von GitHub https://github.com/ZF2Buch/kapitel11 herunter
  laden und in einem geeigneten Verzeichnis entpacken, z.B.
```
  /home/devhost/zf2buch/kapitel11
```
...
```
    ...
    $ git clone https://github.com/ZF2Buch/kapitel11.git
    $ cd kapitel11/
```
...
```
    <VirtualHost *>
      ...
      DocumentRoot /home/devhost/zf2buch/kapitel11/public/
      AccessFileName .htaccess
      <Directory /home/devhost/zf2buch/kapitel11/public/>
